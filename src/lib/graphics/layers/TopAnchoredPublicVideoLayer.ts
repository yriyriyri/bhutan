...
import FIT_WIDTH_TOP_FRAG from '../shaders/fitWidthTop.frag.glsl';

export class TopAnchoredPublicVideoLayer implements Layer {
  id: string;
  visible = true;
  zIndex = 0;
  opacity = 1.0;
  ...
  private makeQuad() {
    const mat = new THREE.ShaderMaterial({
      ...
      fragmentShader: FIT_WIDTH_TOP_FRAG,
      uniforms: {
